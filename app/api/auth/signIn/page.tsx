...
import { Contact, LockIcon, Mail } from "lucide-react";
  ...
  return (
    <div className="w-fit md:mx-8 my-16 h-min-30rem border border-gray-100 p-6 bg-gray-50 rounded-lg text-black shadow-sm">
      ...
      <form className="p-4" onSubmit={handleSubmit(handleContact)}>
        ...
        <input
          className={`text-semibold py-2.5 w-60 rounded-2xl max-w-44 md:w-max-60 md:h-16 cursor-pointer
            ${isloading ? "bg-amber-200 text-amber-500" : "bg-amber-500 text-gray-100"} 
