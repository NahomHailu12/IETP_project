import { LockIcon, LogOutIcon, MailIcon } from "lucide-react";
...
const Sidebar: React.FC<AdminSidebarProps> = ({ item, setItem }) => {
  return (
    <div className="p-4 w-full bg-gray-100 flex flex-col pt-20 border-2 rounded-2xl my-2 border-gray-100 shadow-md">
      <div className="flex justify-end">
        <div
          className={`pl-6 text-gray px-12 py-6 my-4 font-bold text-xl mx-4 rounded-2xl hover:bg-red-300 cursor-pointer block`}
          onClick={() => signOut()}
        >
          <LogOutIcon className="inline mb-1 mr-2 mx-3" size={30} />
          LogOut
        </div>
      </div>
